...
<div class="container">
    <div class="row my-4">
        <div class="col-md-8 mx-auto">
            <div class="card">
                <div class="card-header">Viewing reservation</div>
                <div class="card-body bg-light">
                    <a href="javascript:history.back()" class="btn btn-l btn-danger mr-2 mb-2">
                        <i class="fas fa-caret-left"> Return</i>
                    </a>
                    <form method="post">
                    <input type="hidden" name="id" value="<?php echo $reservation->id;?>" >
                        ...
                        <div class="form-group mt-2 ">
                            ...
                            <select class="form-control" name="bed_type">
                                <option value="<?php echo $reservation->bed_type; ?>" selected readonly><?php echo $reservation->bed_type; ?></option>
                        ...
                        <div class="form-group mt-2">
                            ...
                            <select class="form-control" name="view">
                                <option value="<?php echo $reservation->view; ?>" selected readonly><?php echo $reservation->view; ?></option>
                        ...
                        <div class="container fluid d-flex justify-content-around my-2">
                            <div class="form-group mt-2">
                                ...
                                <select name="kid0_2yo">
                                    <option value="<?php echo $reservation->kid0_2yo; ?>" selected readonly><?php echo $reservation->kid0_2yo; ?></option>
                            ...
                            <div class="form-group mt-2">
                                ...
                                <select name="kid2_14yo">
                                    <option value="<?php echo $reservation->kid2_14yo; ?>" selected readonly><?php echo $reservation->kid2_14yo; ?></option>
                            ...
                            <div class="form-group mt-2">
                                ...
                                <select name="kid14yo">
                                    <option value="<?php echo $reservation->kid14yo; ?>" selected readonly><?php echo $reservation->kid14yo; ?></option>
                        ...
                        <div class="container fluid d-flex justify-content-around my-2">
                            <div class="col-auto my-1">
                                ...
                                <select class="custom-select mr-sm-2" name="add_bed">
                                    <option value="<?php echo $reservation->add_bed; ?>" selected readonly><?php echo $reservation->add_bed; ?></option>
                            ...
                            <div class="col-auto my-1">
                                ...
                                <select class="custom-select mr-sm-2" name="add_room">
                                    <option value="<?php echo $reservation->add_room; ?>" selected readonly><?php echo $reservation->add_room; ?></option>
                                    <option value="0">0</option>
                                    <option value="1">1</option>
                                    <option value="2">2</option>
                                    <option value="3">3</option>
                        ...
                        <div class="form-group mt-2">
                            ...
                            <select class="form-control" name="food_pension">
                                <option value="<?php echo $reservation->food_pension; ?>" selected readonly><?php echo $reservation->food_pension; ?></option>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="entry_date" class="form-control" value="<?php echo $reservation->entry_date; ?>" readonly>
                        </div>

                        <div class="form-group">
                            <label for="exit_date">Check Out</label>
                            <input type="date" name="exit_date" class="form-control" value="<?php echo $reservation->exit_date; ?>" readonly>
                        </div>
                        <!-- <div class="form-group">
